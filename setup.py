...
setup(
    ...
    author_email="marcelovta@al.insper.edu.br",
    description="aps4",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/marcelo-vta/cubo",  # URL do repositório do seu projeto (se houver)
    ...
    entry_points={
        'console_scripts': [
            f'cubo-cli={MODULE_SLUG}.main:app',
        ],
    },
